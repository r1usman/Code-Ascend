...

        {
            ...
            (
                <div className='w-20 h-20 relative rounded-full  bg-blue-100/50 flex items-center justify-center'>
                    ...
                    <button className=' rounded-full p-1 bg-text_primary text-white -right-0 absolute bottom-0' type='button' onClick={onChooseFile}><Upload className='w-4 h-4'/></button>
                </div>
            )
            :
            (
